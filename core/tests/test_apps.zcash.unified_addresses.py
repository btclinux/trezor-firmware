...
TESTVECTORS_UNIFIED = [
	...
	},
	{
		...
		"address": "u17j4lvw84jd238ev9ukr0lvqhv4z32v98pxcglctaj3aqfqj7rr2wwvh73247ekczw4smyrvm2wf2v5nfxvn3sl0ycc6w4455yg49yf2m",
	},
	{
		"receivers": {
		...
		"address": "u1xnkv2m5x02kc5h4fqv3yk0s8z6k4ya7n92an98gsk5dc467ny0rkwevvq3nw7sjll4hvhr2u58xw4cryguzeq0h5yzu4xk3esxgl3glqqth5jqse0za8w5y2ym93ht3zv8wvyw7kvs7ejuvk6xkc375j77ukuzwxkznhuy3x6yvxeq5c",
	},
	{
		"receivers": {
...
class TestZcashAddress(unittest.TestCase):
	def test_encode_unified(self):
		for tv in TESTVECTORS_UNIFIED:
			ua = unified_addresses.encode(tv["receivers"], COIN)
			self.assertEqual(ua, tv["address"])

	def test_decode_unified(self):
		for tv in TESTVECTORS_UNIFIED:
			receivers = unified_addresses.decode(tv["address"], COIN)
			self.assertEqual(receivers, tv["receivers"])
